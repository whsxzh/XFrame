...
class Pagination {
	...
	public function render() {
		...
		if ($num_pages > 1) {
			...
			for ($i = $start; $i <= $end; $i++) {
				if ($page == $i) {
					$output .= '<li class=""><a href="#" style="background:#1D63B2;color:#ffffff">' . $i . '</a></li>';
				} else {
	...
	/**
	 * 分页调用   总数  多少页码  限制多少条数   路径
	 */
	public function page($order_total=0,$page,$limit=20,$url){
		...
		//xindex.php?m=invite&act=getList&page={page}
