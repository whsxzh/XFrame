...
class ControllerApiAlipaySubmit {
    ...
    function ControllerApiAlipaySubmit($alipay_config) {
	...
	function buildRequestMysign($para_sort) {
		...
		switch (1==1) {
			// case "RSA" :
				...
				// break;
			default :
				$mysign = rsaSign($para_sort, dirname(__FILE__). DIRECTORY_SEPARATOR .'key\\rsa_private_key.pem');;
		}
...
//        logResult("sign::::".$sign);
		...
		switch (1==1) {
			// case "RSA" :
				...
				// break;
			default :
				$isSgin = rsaVerify($prestr, trim(dirname(__FILE__). DIRECTORY_SEPARATOR .'key\\alipay_public_key.pem'), $sign);
				// $isSgin = false;
		}
