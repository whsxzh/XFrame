...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetMch_id(WxPayConfig::MCHID);//商户号
		 $inputObj->SetSpbill_create_ip($_SERVER['REMOTE_ADDR']);//终端ip    change  by cgl
//		$inputObj->SetSpbill_create_ip("192.168.0.115");//终端ip
	...
	private static function postXmlCurl($xml, $url, $useCert = false, $second = 30)
	{
		...
		curl_setopt($ch,CURLOPT_SSL_VERIFYHOST,FALSE);//严格校验2 HU修改
		//设置header
