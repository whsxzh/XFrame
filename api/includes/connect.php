...
function getData($sql,$param=array(),$cachetime=0,$refresh=false)
{
	if($cachetime>0&&$refresh==false)
	{
...
function getRow($sql,$param=array(),$cachetime=0,$refresh=false)
{
	if($cachetime>0&&$refresh==false)
	{
		if($rt=getCache(md5($sql)))
